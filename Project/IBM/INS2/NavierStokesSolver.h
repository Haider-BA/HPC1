...
virtual PetscErrorCode generateBC2(); //assemble vector arising from b.c. in RHS of pressure-force solve

PetscErrorCode generateRHS2();

virtual PetscErrorCode generateBNQ(); //assemble matrix BNQ ?? JCP 2007  (26)
